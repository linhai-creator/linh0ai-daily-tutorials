...
> ⏱️ **Thời gian đọc:** 10 phút | **Thực hành:** 5 phút
> 📅 **Ngày 1/30**
...
- Tạo được **bức ảnh AI đầu tiên** trong vòng 2 phút
...
Đợi 5-10 giây. Bạn sẽ có ảnh đầu tiên 🎉

---

## 🎬 Video Demo

📺 **Xem video hướng dẫn 60 giây:** [link YouTube/TikTok của bạn]

*(Trong video bạn quay màn hình từ Bước 1 → Bước 5)*

---

## 💡 Prompt mẫu

📂 File: [`prompts/day-01.txt`](../prompts/day-01.txt) và [`prompts/day-01.json`](../prompts/day-01.json)

**Bản tiếng Việt** (test xem model hiểu tiếng Việt thế nào):
```
Quán cà phê Việt Nam ấm cúng vào buổi sáng sớm, ánh nắng ấm chiếu qua 
cửa sổ, một ly cà phê sữa đá trên bàn gỗ, phong cách vintage, hậu cảnh 
mờ nghệ thuật, ảnh chân thực, độ chi tiết cao
```
...
Sau khi tạo được ảnh đầu tiên, **đổi 1 thứ trong prompt** và thử lại:
- Đổi `coffee shop` → `phở restaurant`
- Đổi `early morning` → `late evening`
- Đổi `wooden table` → `marble table`

📸 Chụp screenshot kết quả → comment trong [Issue #1](../../issues/1) hoặc post lên Facebook tag mình.
...
| Hết credit nhanh | Đang dùng model Pro — chuyển về Schnell khi tập luyện |
...
A: Có credit miễn phí khi đăng ký để bạn thử. Dùng nhiều thì cần nạp thêm.

**Q: Mình cần biết tiếng Anh không?**
A: Không bắt buộc. Một số model hiểu tiếng Việt khá tốt. Day 5 sẽ test cụ thể.
...
*Tác giả: [tên của bạn] · #0aiDay01 #AITaoAnh #0aiVN*
