...
- 📊 Test 15 ảnh: 5 quy tắc × 3 chủ đề × GPT Image 2
...
- **Phong cảnh:** Phố cổ Hội An (mới, không trùng Day 8 Mù Cang Chải)
- **Sản phẩm:** Đồng hồ luxury generic (test brand insight lần 3)
...
### ✨ Thêm mới
- **Day 2 — Đăng ký + Credit Strategy + Dashboard Tour** ([đọc](./days/day-02.md))
...
- [ ] Upscale & enhance
- [ ] Case study: bộ ảnh sản phẩm shop online

### Tuần 4 (Day 22-28)
- [ ] Seedance 2.0 video — text-to-video, image-to-video
- [ ] Camera movements, character consistency
- [ ] Ghép clip thành scene dài

### Bonus (Day 29-30)
- [ ] Case study: quảng cáo sản phẩm 30s từ A-Z
- [ ] Tổng kết hành trình + roadmap học tiếp
