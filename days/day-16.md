...
**Tạo ảnh hoạt hình 3D phong cách Trung Quốc**

Day 17 mình sẽ chuyển hướng sang một chủ đề đang rất hot: tạo ảnh hoạt hình 3D phong cách Trung Quốc (xianxia). Các bạn sẽ học:

- Master 5 thành phần prompt 3D animation chuẩn
- Phân biệt bố cục 9:16 vs 16:9 cho TikTok và YouTube
- Cách tạo Character Sheet để giữ nhân vật consistent qua nhiều ảnh
- Tránh 5 mistakes phổ biến khi clone style 3D Trung Quốc

→ Day 17 = Xây dựng foundation hiểu prompt 3D Trung Quốc chuẩn cinematic.
...
[⬅️ Day 15: File & Folder Management](https://github.com/linhai-creator/linh0ai-daily-tutorials/blob/main/days/day-15.md) | [🏠 README](https://github.com/linhai-creator/linh0ai-daily-tutorials/blob/main/README.md) | [➡️ Day 17: Tạo ảnh hoạt hình 3D phong cách Trung Quốc](https://github.com/linhai-creator/linh0ai-daily-tutorials/blob/main/days/day-17.md)
